...
sap.ui.define([
		...
		"opensap/manageobjects/ManageObjects/model/formatter",
		"sap/ui/model/Filter",
		"sap/ui/model/FilterOperator"
	], function (BaseController, JSONModel, formatter, Filter, FilterOperator) {
		"use strict";

		return BaseController.extend("opensap.manageobjects.ManageObjects.controller.Worklist", {
			...
			onQuickFilter : function (oEvent) {
				var sKey = oEvent.getParameters("key"),
					oFilter = this._mFilters[sKey.key],
					oTable = this.byId("table"),
