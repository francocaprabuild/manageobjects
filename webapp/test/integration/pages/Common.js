sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("opensap/manageobjects/ManageObjects/app", ".html");
		...
		return Opa5.extend("opensap.manageobjects.ManageObjects.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["opensap/manageobjects/ManageObjects/localService/mockserver"], function (mockserver) {
